...
<?php if ($nav == "classifications") { ?>
 &raquo; <?php echo $navLoc->getText("MemberTypes");?><br>
<?php } else { ?>
 <a href="../admin/mbr_classify_list.php" class="alt1"><?php echo $navLoc->getText("MemberTypes");?></a><br>
<?php } ?>

<?php if ($nav == "member_fields") { ?>
 &raquo; <?php echo $navLoc->getText("MemberFields");?><br>
<?php } else { ?>
 <a href="../admin/member_fields_list.php" class="alt1"><?php echo $navLoc->getText("MemberFields");?></a><br>
<?php } ?>

<?php if ($nav == "copy_fields") { ?>
 &raquo; <?php echo $navLoc->getText("CopyFields");?><br>
<?php } else { ?>
 <a href="../admin/copy_fields_list.php" class="alt1"><?php echo $navLoc->getText("CopyFields");?></a><br>
<?php } ?>
...
<?php if ($nav == "checkout_privs") { ?>
 &raquo; <?php echo $navLoc->getText("CheckoutPrivs");?><br>
<?php } else { ?>
 <a href="../admin/checkout_privs_list.php" class="alt1"><?php echo $navLoc->getText("CheckoutPrivs");?></a><br>
<?php } ?>
