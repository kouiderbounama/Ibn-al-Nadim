...
#****************************************************************************
$trans["biblioError1"]            = "\$text = 'Call number is verplicht.';";
...
$trans["biblioCopyError2"]        = "\$text = 'Barcode number moet letters en/of cijfers zijn.';";
...
#  $trans["mbrCardNumberError1"]            = "\$text = 'Card number is required.';";
  $trans["mbrCardNumberError1"]             = "\$text = 'Card number is verplicht.';";
#  $trans["mbrCardNumberError2"]            = "\$text = '"Card number must be all alphabetic and numeric characters."';";
  $trans["mbrCardNumberError2"]             = "\$text = 'Card number moet alfanumeriek zijn.';";
...
#  $trans["mbrZipCodeError1"]               = "\$text = 'Zip code number must be numeric.';";
  $trans["mbrZipCodeError1"]                = "\$text = 'Zip code nummer moet een getal zijn.';";
#  $trans["mbrZipCodeError2"]               = "\$text = 'Zip code number must not contain a decimal point.';";
  $trans["mbrZipCodeError2"]                = "\$text = 'Zip code nummer mag geen decimaal-punt bevatten.';";
#  $trans["mbrZipCodeError1"]               = "\$text = 'Zip code extension must be numeric.';";
  $trans["mbrZipCodeError1"]                = "\$text = 'Zip code extensie moet een getal zijn.';";
#  $trans["mbrZipCodeExtError2"]            = "\$text = 'Zip code extension must not contain a decimal point.';";
  $trans["mbrZipCodeExtError2"]             = "\$text = 'Zip code nummer mag geen decimaal-punt bevatten.';";
#  $trans["mbrSchoolGradeError1"]           = "\$text = 'School Grade must be numeric.';";
  $trans["mbrSchoolGradeError1"]            = "\$text = 'Nivo moet een getal zijn.';";
#  $trans["mbrSchoolGradeError2"]           = "\$text = 'SchoolGrade must not contain a decimal point.';";
  $trans["mbrSchoolGradeError2"]            = "\$text = 'Nivo mag geen decimaal-punt bevatten.';";
...
#  $trans["themeNameError"]                    = "\$text = 'Theme name is required.';";
  $trans["themeNameError"]                     = "\$text = 'Thema naam is verplicht.';";
...
#****************************************************************************
#*  Translation text for class ScrInfo
#****************************************************************************
#  $trans["ScrInfoTypeError"]                  = "\$text = 'Type subscription is required.';";
  $trans["ScrInfoTypeError"]                   = "\$text = 'Type abonnement is verplicht.';";
#  $trans["ScrInfoFeeError"]                   = "\$text = 'Fee subscription is required.';";
  $trans["ScrInfoFeeError"]                    = "\$text = 'Bedrag abonnement is verplicht.';";
#  $trans["ScrInfoBookcountError"]             = "\$text = 'Bookcount subscription is required.';";
  $trans["ScrInfoBookcountError"]              = "\$text = 'Aantal boeken abonnement is verplcht.';";
