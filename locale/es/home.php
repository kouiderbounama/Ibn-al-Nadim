...
$trans["indexAdminDesc13"]		= "\$text='Opciones para búsquedas mediante Z39.50';";
$trans["indexAdminDesc14"]		= "\$text='Gestión de Servidores para búsquedas Z39.50';";
$trans["indexAdminDesc15"]		= "\$text='Búsqueda masiva de datos vía ISBN en Servidores Z39.50';";
$trans["indexAdminDesc16"]		= "\$text='Importar lista de usuarios desde un archivo CSV';";
...
$trans["indexAdminDesc22"]		= "\$text='Administrador de Traduciones';";
...
$trans["indexCatDesc4"]			= "\$text='Poner a disposición materiales digitales para su descarga';";
$trans["indexCatDesc5"]			= "\$text='Eliminación de Bibliografías por lotes';";
$trans["indexCatDesc6"]			= "\$text='Recuperación de información Bibliográfica desde servidores con soporte protocolo Z39.50 YAZ y SRU.';";
$trans["indexCatDesc7"]			= "\$text='Importar bibliografía por lotes desde de un archivo CSV.';";
$trans["indexCatDesc8"]			= "\$text='Importar datos Bibliográficos USMarc desde archivos';";
$trans["indexCatDesc9"]			= "\$text='Recuperación de información Bibliográfica desde la Biblioteca del Congreso de los USA utilizando SRU [Search Retrival URL], (no requiere configuración YAZ)';";
$trans["indexCatDesc10"]		= "\$text='Tablas Clasificación Decimal Universal (CDU), Basado en las publicaciones de AENOR/España';";
$trans["indexCatDesc11"]		= "\$text='Tablas Clasificación Decimal Dewey (CDD)';";
$trans["indexCatDesc12"]		= "\$text='Tablas de la internacional industria de libros [International Book Industry Categories] (IBIC)';";
$trans["indexCirc"]			= "\$text='Circulación (prestamos)';";
$trans["indexCircDesc1"]		= "\$text='Utiliza esta página para administrar los datos de los socios y movimientos de materiales.';";
$trans["indexCircDesc2"]		= "\$text='Administración de socios (añadir nuevos, buscar, editar, borrar, poner foto, imprimir carnet e historial)';";
...
$trans["indexCircDesc6"]		= "\$text='Importar lista de miembros desde un archivo CSV.';";
$trans["indexCircDesc7"]		= "\$text='Actualización por movimientos de materiales fuera de linea';";
$trans["indexDesc"]			= "\$text='Descripción';";
$trans["indexGen"]			= "\$text='Otras Funciones de caracteres general';";
$trans["indexGenDesc1"]			= "\$text='Estas son capacidades de la Versión -Giordano Bruno- que no son propiamente del programa.';";
...
$trans["indexGenDesc12"]		= "\$text='Otras Herraminetas para OSE y robots';";
$trans["indexGenDesc13"]		= "\$text='Funcion circ2, para que los usuarios puedan ver su estatus y pedir reservas de libros';";
$trans["indexGenDesc2"]			= "\$text='Indexación para Busquedas de google y google analycts.';";
...
$trans["indexGenDesc5"]			= "\$text='/api. de openbiblio generica';";
$trans["indexGenDesc6"]			= "\$text='/cron. Proporciona funciones de sincronización y cronometro';";
...
$trans["indexIntro"]			= "\$text='Utiliza las pestañas superiores para acceder a las diferentes páginas de administración de la biblioteca.';";
...
$trans["indexReportsDesc5"]		= "\$text='Adquisición.';";
$trans["indexReportsDesc6"]		= "\$text='Búsqueda de copia.';";
