<h1>Comprender los cambios de estado de la Bibliografía:</h1>
La siguiente tabla muestra el estado de los estados posibles comunes de una copia de la bibliografía, es posible agregar más, segun lo requiera.<br><br>
<table class="primary">
