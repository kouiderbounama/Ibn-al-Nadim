<h1>Bibliografía Nueva y edicción :</h1>
The bibliography new and edit (Edit-Basic) page fields are based on 
the <a href="javascript:popSecondaryLarge('http://www.loc.gov/marc')">MARC 21</a> formato estandar.<br>
...
<ul>
  <li><a href="#desc">Campo de descripcion</a></li>
  <li><a href="#samp">Datos de Ejemplo</a></li>
</ul>
<br><br>
<a name="desc">
...
Los campos marcados con * son requeridos.</font>
<table class="primary">
  <tr>
    <th colspan="2" valign="top" nowrap="yes" align="left">
      Añadir nuevo Bibliografía:
    </td>
  </tr>
  <tr>
    <td nowrap="true" class="primary">
      <sup>*</sup> Tipo de material:
    </td>
    <td valign="top" class="primary">
<select id="materialCd" name="materialCd" onChange="matCdReload()">
<option value="1">audio casettes</option>
<option value="3">cd audio</option>
<option value="4">cd software</option>
<option value="5">equipos</option>
<option value="2" selected>libros</option>
<option value="7">mapas</option>
...
<option value="3" >Cassettes</option>
<option value="4" >CD</option>
<option value="1" >Ficcion adulto</option>
<option value="7" >Ficcion Juvenil</option>
<option value="6" >Lectura Facil</option>
<option value="2" >No ficción Adulto</option>
<option value="8" >No ficcion Juvenil</option>
<option value="9" >Novedad Libro</option>
<option value="5" >PC Software</option>
<option value="10" >Periodicos</option>
<option value="11" >Referencia</option>
<option value="12" >Videos y DVDs</option>
</select>
    </td>
  </tr>
  <tr>
    <td nowrap="true" class="primary" valign="top">
      <sup>*</sup> Número de entrada:
    </td>
    <td valign="top" class="primary">
...
<input type="hidden" name="requiredFlgs[245b]" value="" >
  ...
  <tr><td class="primary" valign="top">
La declaración de responsabilidad, etc.:
</td>
<td valign="top" class="primary">
...
<input type="hidden" name="requiredFlgs[100a]" value="1" >
    ...
    <td nowrap="true" class="primary">
      Seleccionar archivo a subir para autor.<sup>(5)</sup>: 
    </td>
      <td colspan="2" nowrap="true" class="primary">
