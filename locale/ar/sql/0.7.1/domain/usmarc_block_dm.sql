...
insert into %prfx%usmarc_block_dm values (1,'المدخلة الرئيسية');
insert into %prfx%usmarc_block_dm values (2,'عنوان وعنوان الفقرة (عنوان, edition, imprint)');
insert into %prfx%usmarc_block_dm values (3,'الوصف المادي، إلخ');
insert into %prfx%usmarc_block_dm values (4,'Series statements');
insert into %prfx%usmarc_block_dm values (5,'ملاحظات');
insert into %prfx%usmarc_block_dm values (6,'حقول مداخل الموضوع');
